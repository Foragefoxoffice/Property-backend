...
const CreatePropertySchema = new mongoose.Schema(
  {
    ...
    financialDetails: {
      ...
      financialDetailsAgentFee: LocalizedString,
    ...
    contactManagement: {
      ...
      contactManagementOwnerId: { type: mongoose.Schema.Types.ObjectId, ref: "Owner" },
    ...
    financialVisibility: {
      ...
      leasePrice: { type: Boolean, default: false },
      pricePerNight: { type: Boolean, default: false },
      ...
      agentFeeAgenda: { type: Boolean, default: false },
